...
set MINGW_PATH=g:\SoftWare\QT6.8.3\Tools\mingw0_64
...
cd build
qmake.exe %PRO_DIR%\XR-Map_3dVer_Qt6.pro -spec win32-g++ "CONFIG+=release"
if exist %BUILD_DIR%\release\XR-Map_3dVer_Qt6.exe del %BUILD_DIR%\release\XR-Map_3dVer_Qt6.exe
