...
#include <memory>
#include "../../../src/scene3d/utils/ray.h"
...
QT_MOC_LITERAL(1, 4, 13), // "originChanged"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 6), // "origin"
QT_MOC_LITERAL(4, 26, 16), // "directionChanged"
QT_MOC_LITERAL(5, 43, 9), // "direction"
QT_MOC_LITERAL(6, 53, 9), // "setOrigin"
QT_MOC_LITERAL(7, 63, 12), // "setDirection"
QT_MOC_LITERAL(8, 76, 3) // "dir"

    },
    "Ray\0originChanged\0\0origin\0directionChanged\0"
    "direction\0setOrigin\0setDirection\0dir"
};
...
void Ray::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Ray *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->originChanged((*reinterpret_cast< QVector3D(*)>(_a[1]))); break;
        case 1: _t->directionChanged((*reinterpret_cast< QVector3D(*)>(_a[1]))); break;
        case 2: _t->setOrigin((*reinterpret_cast< const QVector3D(*)>(_a[1]))); break;
        case 3: _t->setDirection((*reinterpret_cast< const QVector3D(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Ray::*)(QVector3D );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Ray::originChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Ray::*)(QVector3D );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Ray::directionChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Ray::originChanged(QVector3D _t1)
{
...
// SIGNAL 1
void Ray::directionChanged(QVector3D _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
