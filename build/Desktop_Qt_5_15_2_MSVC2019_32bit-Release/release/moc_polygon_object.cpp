/****************************************************************************
** Meta object code from reading C++ file 'polygon_object.h'
**
...
#include <memory>
#include "../../../src/scene3d/domain/polygon_object.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'polygon_object.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject PolygonObject::staticMetaObject = { {
    QMetaObject::SuperData::link<PointGroup::staticMetaObject>(),
...
void *PolygonObject::qt_metacast(const char *_clname)
{
    ...
    return PointGroup::qt_metacast(_clname);
}

int PolygonObject::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = PointGroup::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
